...
void RegTemperature(){
    ...
    lcd.write(223);
    lcd.print("C");
    if((Temp<30 && ContMOT1 == true) ||(Temp>=30 && ContMOT1 == false) ||(Temp>=30 &&
    ContMOT1 == true))
...
void AutoEclerage(){
    ...
    //Serial.println(Eclr);
    if ((Eclr < 600 && ContLMP == true)||(Eclr >= 600 && ContLMP == false)||(Eclr >= 600 &&
    ContLMP == true) ){
...
void ContRideaux(){
    ...
    if(((ContMOT2 == true && HumidDht12 < 80 )|| (ContMOT2 == true && HumidDht12 >=80 ))and
    BasM1== true and HautM1== false){
    ...
    if(((ContMOT2 == false && HumidDht12 <80 )||(ContMOT2 == false &&
    HumidDht12 >=80 ) )and HautM1 == true and BasM1 == false){
        // DescandeCommande
        digitalWrite(Mot1Pin1,LOW);
